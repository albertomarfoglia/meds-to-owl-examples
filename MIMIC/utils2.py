...
def generate_samples(n_folds: int, labels: pl.LazyFrame, size: int, seed: int | None):
    true_values = (
    ...
    true_values = true_values.sample(n=fold_length * n_folds, shuffle=True, seed=seed)
